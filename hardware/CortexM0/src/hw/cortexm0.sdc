...
create_clock -name "HCLK" -period "$CLK_PERIOD" -waveform "0 [expr $CLK_PERIOD/2]" [get_ports HCLK]
...
set_input_delay 	-max [expr $MAX_IO_DLY] 				-clock "HCLK"	[all_inputs]
set_input_delay 	-min [expr -$MAX_IO_DLY] 				-clock "HCLK" 	[all_inputs]
set_output_delay 	-max [expr $MAX_IO_DLY] 				-clock "HCLK"	[all_outputs]
set_output_delay 	-min [expr -$MAX_IO_DLY] 				-clock "HCLK" 	[all_outputs]
